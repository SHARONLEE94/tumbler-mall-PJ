...
<main class="max-w-4xl mx-auto px-4 py-12">
  ...
  <div class="bg-gradient-to-r from-beige-100 to-beige-200 rounded-lg p-8 mb-8">
    <div class="grid md:grid-cols-3 gap-6 text-center">
      ...
      <div>
        ...
        <p class="text-lg text-gray-900"><%= orderDate %></p>
      </div>
      <div>
    ...
    <div class="bg-white border border-beige-200 rounded-lg">
      ...
      <div class="p-6">
        <div class="space-y-4">
          ...
          <div class="flex gap-4 p-4 bg-beige-50 rounded-lg">
            <img src="텀블러이미지" alt="텀블러"
                 class="w-16 h-20 object-cover rounded">
            <div class="flex-1">
              <h3 class="font-medium text-gray-900 mb-1">스텐리</h3>
              <p class="text-sm text-beige-600 mb-2">
                색상: 포멜로 / 사이즈: 50oz
              </p>
      ...
      <div class="bg-white border border-beige-200 rounded-lg">
        ...
        <div class="p-6 space-y-3">
          ...
          <div class="flex justify-between">
            ...
            <span class="text-gray-900">₩123456 %></span>
          </div>
          <div class="flex justify-between">
          ...
          <div class="flex justify-between text-lg font-medium">
            ...
            <span class="text-gray-900">₩456789456 %></span>
          </div>
  ...
  <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
    ...
    <div class="grid md:grid-cols-3 gap-4 text-sm">
      <div class="flex items-start gap-3">
        <div class="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-medium">1</div>
        <div>
      ...
      <div class="flex items-start gap-3">
        <div class="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-medium">2</div>
        <div>
      ...
      <div class="flex items-start gap-3">
        <div class="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-medium">3</div>
        <div>
  ...
  <div class="flex flex-col sm:flex-row gap-4 mt-8">
    <a href="/orderDetl?orderNumber=<%= orderNumber %>"
...
<div id="successModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  <div class="bg-white rounded-lg p-8 max-w-md mx-4">
    <div class="text-center">
      ...
      <p class="text-beige-600 mb-6">주문번호: <%= orderNumber %></p>
